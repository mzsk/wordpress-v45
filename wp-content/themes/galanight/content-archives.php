<?php
/**
 * The template for displaying content of the search/archive entries.
 * @package GalaNight
...
<?php if ( get_theme_mod('galanight_display_meta_post_entry', galanight_default_options('galanight_display_meta_post_entry')) != 'Hide' ) { ?>
        <p class="post-meta">
...
<?php } ?>
        <div class="post-entry-content"><?php if ( get_theme_mod('galanight_content_archives', galanight_default_options('galanight_content_archives')) != 'Content' ) { ?><?php the_excerpt(); ?><?php } else { ?><?php global $more; $more = 0; ?><?php the_content(); ?><?php } ?></div>
    </article>